...
<body class="toggle-sidebar">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle py-2">
            <h1>I. ເລ​ຂາ​ບໍ​ລິ​ຫານ​ງານ​ພັກ</h1>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="my-4"><i class="bi bi-asterisk"></i> ​ພິມເລກ​ທີ່​ໃບ​ລົງ​ຄະ​ແນນ ໃສ່​ຫ້ອງ​ທາງ​ລຸ່ມ</h4>

                            <form class="row g-3" action="os_action" method="post" id="scanForm">
                                ...
                                <div class="col-12">
                                    ...
                                    <br>
                                    <div class="col-12">
                                        <h4><i class="bi bi-asterisk"></i> <?= $kill1 ?> ສ​ະ​ຫາຍທີ່​ທ່ານບໍ່​ເລືອກເອົາ</h4>
                                        <?php
                                        for ($i = 1; $i <= $kill1; $i++) {
                                            echo '<input type="text" name="oc_id[]" id="oc_id_' . $i . '" class="form-control mb-3" maxlength="2" placeholder="ຜູ້​ທີ່ ' . $i . '" required>';
                                        }
                                        ?>
                                    </div>
                                </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php foreach ($data as $row) { ?>
                                        <tr>
                                            <td class="text-center"><?= $row['oc_id']; ?></td>
                                            <td><?= $row['oc_name']; ?></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
        ...
        document.getElementById("scanForm").addEventListener("keydown", function(event) {
            if (event.key === "Enter") {
                ...
                if (activeElement.id === "s_no") {
                    // focus ช่องแรก
                    if (killCount >= 1) document.getElementById("oc_id_1").focus();
                } else {
                    // check ว่าช่องที่ active อยู่เป็น oc_id_X
                    for (let i = 1; i <= killCount; i++) {
                        if (activeElement.id === "oc_id_" + i) {
                            if (i < killCount) {
                                // focus ช่องถัดไป
                                document.getElementById("oc_id_" + (i + 1)).focus();
                            } else {
