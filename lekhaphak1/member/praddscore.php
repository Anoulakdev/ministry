...
// GET OLD CANDIDATE
// ---------------------------------------------
$query1 = "SELECT * FROM oldcandidate1";
...
<head>
    ...
    <title>ລົງ​ຄະ​ແນນສະ​ໝັກເລ​ຂາ</title>
...
<body class="toggle-sidebar">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle py-2">
            <h1>I. ເລ​ຂາ​ບໍ​ລິ​ຫານ​ງານພັກ</h1>
        </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="pr_action" method="post" onsubmit="return handleSubmit()">
                                            ...
                                            <tbody class="text-center align-middle">
                                                <?php foreach ($data1 as $row1): ?>
                                                    <tr>
                                                        <td>
                                                            <input type="radio"
                                                                name="osc1_result_<?= $row1['oc1_id']; ?>"
                                                                value="1" checked
                                                                onclick="toggleTextarea(<?= $row1['oc1_id']; ?>, true)">
                                                            ສືບຕໍ່

                                                            <input type="radio"
                                                                name="osc1_result_<?= $row1['oc1_id']; ?>"
                                                                value="0"
                                                                onclick="toggleTextarea(<?= $row1['oc1_id']; ?>, false)">
                                                            ບໍ່ສືບຕໍ່
                                                        </td>

                                                        <td>
                                                            <textarea
                                                                name="osc1_reason_<?= $row1['oc1_id']; ?>"
                                                                id="osc1_reason_<?= $row1['oc1_id']; ?>"
                                                                rows="2" class="form-control"
                                                                disabled></textarea>
                                                        </td>

                                                        <td class="text-center"><?= $row1['oc1_name']; ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php foreach ($data as $row): ?>
                                        <tr>
                                            <td class="text-center"><?= $row['nc1_id']; ?></td>
                                            <td><?= $row['nc1_name']; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
    ...
    <script>
        ...
        function toggleTextarea(id, isContinue) {
            const txt = document.getElementById("osc1_reason_" + id);
            if (isContinue) {
                txt.disabled = true;
                txt.value = "";
