                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="row g-3" action="nc_action" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="theory" class="form-label">ທິດ​ສະ​ດີ</label>
                                                        <input type="text" name="theory" class="form-control">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label for="nc_part" class="form-label">​ກົມ​ກອງ​</label>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="row g-3" action="nc_action" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="col-md-12 mt-2">
                                                                        <label for="theory" class="form-label">ທິດ​ສະ​ດີ</label>
                                                                        <input type="text" name="theory" value="<?= $row['theory']; ?>" class="form-control">
                                                                    </div>
                                                                    <div class="col-md-12 mt-2">
