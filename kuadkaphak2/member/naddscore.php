                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="my-4"><i class="bi bi-asterisk"></i> ພີມເລກ​ທີ່​ໃບ​ລົງ​ຄະ​ແນນ ໃສ່​ຫ້ອງ​ທາງ​ລຸ່ມ</h4>

                            <form class="row g-3" action="ns_action" method="post" id="scanForm">
                                ...
                                <div class="col-12">
                                    ...
                                    <br>
                                    <div class="col-12">
                                        <h4><i class="bi bi-asterisk"></i> <?= $kill2 ?> ສ​ະ​ຫາຍທີ່​ທ່ານບໍ່​ເລືອກເອົາ</h4>
                                        <?php
                                        for ($i = 1; $i <= $kill2; $i++) {
