                            ...
                            <div class="card-body">
                                <div class="row p-3">
                                    <div class="d-flex justify-content-between">
                                        <h1 class="text-decoration-underline text-primary">ຜົນ​ຄະ​ແນນຮອງ​ປະ​ທານ</h1>
