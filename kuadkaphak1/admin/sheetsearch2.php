...
<head>
    ...
    <title>ລົງ​ຄະ​ແນນ​ເປົ້າ​ໝາຍ​ໃໝ່(ຮອງປະ​ທານ)</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle py-2">
            <h1>ລົງ​ຄະ​ແນນ​ເປົ້າ​ໝາຍ​ໃໝ່(ຮອງປະ​ທານ)</h1>
                                    ...
                                    <tbody>
                                        ...
                                        <?php for ($i = 0; $i < count($obj); $i++) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?= $obj[$i]->nc2_name; ?></td>
