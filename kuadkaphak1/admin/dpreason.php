...
<head>
    ...
    <title>ຄຳ​ເຫັນ​ຕໍ່​ຄະ​ນະ​ຊຸດ​ເກົ່າ(ຮອງປ​ະ​ທານ)</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle py-2">
            <h1>ຄຳ​ເຫັນ​ຕໍ່​ຄະ​ນະ​ຊຸດ​ເກົ່າ(ຮອງປ​ະ​ທານ)</h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start">
                                <form action="" method="GET" class="my-3 d-flex align-items-center">
                                    <select name="oc2_id" class="form-select me-3">
                                        <option value="">---ເລືອກຜູ້​ສະ​ໝັກ​ຊຸດ​ເກົ່າ---</option>
                                        <?php
                                        $query3 = 'SELECT * FROM oldcandidate2 ORDER BY oc2_id ASC';
                                        $stmt3 = $conn->prepare($query3);
                                        $stmt3->execute();
                                        $result3 = $stmt3->get_result();

                                        while ($row3 = $result3->fetch_assoc()) {
                                            $selected = ($oc2_id == $row3['oc2_id']) ? "selected" : "";
                                            echo "<option value='" . htmlspecialchars($row3['oc2_id']) . "' $selected>" . htmlspecialchars($row3['oc2_name']) . "</option>";
                                        }
                                        ?>
                                    </select>
                            ...
                            <?php if (isset($_GET['filter'])) { ?>
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="ocexcel2?oc2_id=<?= htmlspecialchars($_GET['oc2_id']); ?>" class="btn btn-success my-3" target="_blank">
                                    ...
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            curl_setopt_array($curl, array(
                                                CURLOPT_URL => $apioreason2 . '?oc2_id=' . $oc2_id,
