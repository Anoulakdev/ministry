    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="deputypresident">
                <i class="bi bi-person"></i>
                <span>ຜູ້​ສະ​ໝັກຮອງ​ປະ​ທານ</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="prreason">
                <i class="bi bi-receipt"></i>
                <span>ຄຳ​ເຫັນ​ຕໍ່​ຄະ​ນະ​ຊຸດ​ເກົ່າ(ປ​ະ​ທານ)</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="prscore">
                ...
                <span>​ຜົນ​ຄະ​ແນນປະ​ທານ</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="dpscore">
                <i class="bi bi-sliders"></i>
                <span>​ຜົນ​ຄະ​ແນນ​ຮອງ​ປະ​ທານ</span>
            </a>
        </li>
    </ul>
